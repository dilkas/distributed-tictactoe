...
Coding is the main occupation of many people nowadays, and is also a
past-time for many too. Most people get their first steps in writing code
...
programming methods and techniques in an engaging way \cite{3}. For this reason, 
the team has decided to take a simple, well known game and develop it into a distributed 
system; Tic Tac Toe played as a peer-to-peer, team-based gaming system where the players are organised into teams and required to vote on moves for their team. 
...
be found \cite{1} but there is a high possibility that they might be incomprehensible 
